...
public class ODMcomplexTypeDefinitionItemDataPartialDatetime implements ItemDataStar
{
    ...
    public ODMcomplexTypeDefinitionItemDataPartialDatetime() {
        super();
    }

    
    public ODMcomplexTypeDefinitionItemDataPartialDatetime(final String value, final Object auditRecordID, final Object signatureID, final Object annotationID, final String measurementUnitOID, final String itemOID, final TransactionType transactionType) {
        this.value = value;
